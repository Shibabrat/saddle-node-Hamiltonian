...
ax = plt.gca()
e=0.01
plot1 = ax.plot(F[:,4],widthratio(alpha,mu,omega,epsilon,e),label=r'$R_{bw}$ of the coupled system, $\mu=4,\omega=3,e=0.01$') # plot width ratio as a function of alpha
e=0.05
plot2 = ax.plot(F[:,4],widthratio(alpha,mu,omega,epsilon,e),label=r'$R_{bw}$ of the coupled system, $\mu=4,\omega=3,e=0.05$') # plot width ratio as a function of alpha
e=0.1
plot3 = ax.plot(F[:,4],widthratio(alpha,mu,omega,epsilon,e),label=r'$R_{bw}$ of the coupled system, $\mu=4,\omega=3,e=0.1$') # plot width ratio as a function of alpha
e=0.5
plot4 = ax.plot(F[:,4],widthratio(alpha,mu,omega,epsilon,e),label=r'$R_{bw}$ of the coupled system, $\mu=4,\omega=3,e=0.5$') # plot width ratio as a function of alpha
e=1.0
plot6 = ax.plot(F[:,4],widthratio(alpha,mu,omega,epsilon,e),label=r'$R_{bw}$ of the coupled system, $\mu=4,\omega=3,e=1.0$') # plot width ratio as a function of alpha
